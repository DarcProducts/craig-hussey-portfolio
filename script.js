document.addEventListener("DOMContentLoaded", function() {
    ...
    var descriptions = [
      ...
      "<char style='color:gold;font-size:2rem;text-shadow:2px -2px 0px black'>Space Manheuvers</char><p>This game was created in a week for a school project. It was built to resemble the arcade game Galaga made in 1981. In this game, the player controls a space ship and tries to stay alive as long as possible, avoiding enemy space ships. The game incorporates a shield that protects the player, and weapon power ups to destroy the enemies quicker.",
